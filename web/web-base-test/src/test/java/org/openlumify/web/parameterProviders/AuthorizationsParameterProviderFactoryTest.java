...
public class AuthorizationsParameterProviderFactoryTest {
    ...
    public void testGetAuthorizations() {
        ...
        when(request.getAttribute(eq(OpenLumifyBaseParameterProvider.WORKSPACE_ID_ATTRIBUTE_NAME))).thenReturn("workspace123");
    ...
    public void testGetAuthorizationsNoWorkspace() {
        ...
        when(request.getAttribute(eq(OpenLumifyBaseParameterProvider.WORKSPACE_ID_ATTRIBUTE_NAME))).thenReturn(null);
