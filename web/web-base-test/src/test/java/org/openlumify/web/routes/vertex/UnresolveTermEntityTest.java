...
public class UnresolveTermEntityTest extends RouteTestBase {
    ...
    public void testHandle() throws Exception {
        ...
        graph.addEdge("v1_to_c1tm1", v1, v1tm1, OpenLumifyProperties.TERM_MENTION_LABEL_HAS_TERM_MENTION, termMentionVisibility, authorizations);
        graph.addEdge("c1tm1_to_v2", v1tm1, v2, OpenLumifyProperties.TERM_MENTION_LABEL_RESOLVED_TO, termMentionVisibility, authorizations);
