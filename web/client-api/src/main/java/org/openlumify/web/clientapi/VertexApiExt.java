...
import org.openlumify.web.clientapi.codegen.VertexApi;
import org.openlumify.web.clientapi.model.*;
import org.openlumify.web.clientapi.util.FileUtils;
...
public class VertexApiExt extends VertexApi {
    public static final int VIDEO_TRANSCRIPT_INDEX_BITS = 12; // duplicated in org.openlumify.core.model.textHighlighting.OffsetItem
    public static final int VIDEO_TRANSCRIPT_OFFSET_BITS = 20; // duplicated in org.openlumify.core.model.textHighlighting.OffsetItem
