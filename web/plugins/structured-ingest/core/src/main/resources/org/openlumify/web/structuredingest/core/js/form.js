define([
    ...
    function StructuredMappingForm() {
        ...
        this.onCreatedObjectsClick = function(event) {
            ...
            if (this.$node.find('.segmented-control .entities.active').length) {
                ...
                Promise.all([
                    ...
                    Promise.require('org/openlumify/web/structuredingest/core/js/createdObjectPopover')
        ...
        this.ingestPreview = function() {
            ...
            this.dataRequest('org-openlumify-structuredingest', 'ingest', mapping, self.attr.vertex.id, this.parseOptions, this.currentImportActionIsPreview, this.shouldPublish)
                .then(function(result) {
