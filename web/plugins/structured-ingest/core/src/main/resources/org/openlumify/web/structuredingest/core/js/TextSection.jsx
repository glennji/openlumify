define([
    ...
    'use strict';
    const VISIBILITY_NAME = 'http://openlumify.org#visibilityJson';
    ...
    const StructuredIngestTextSection = createReactClass({
        ...
        render() {
            ...
            return (
                <div className="com-openlumify-structuredFile-text-table">
                    {canEdit ?
        ...
        onClick() {
            ...
            require([
                'org/openlumify/web/structuredingest/core/js/form',
                'org/openlumify/web/structuredingest/core/templates/modal.hbs'
