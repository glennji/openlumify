...
import org.openlumify.web.structuredingest.core.util.StructuredFileParserHandler;
...
public class ParquetStructuredIngestParser implements StructuredIngestParser {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(ParquetStructuredIngestParser.class);
    ...
    public ClientApiAnalysis analyze(InputStream inputStream) throws Exception {
        ...
        try {
            ...
            for (ColumnDescriptor col : schema.getColumns()) {
                ...
                if (colPath.length == 0) {
                    throw new OpenLumifyException("structured file path has no elements");
                }
