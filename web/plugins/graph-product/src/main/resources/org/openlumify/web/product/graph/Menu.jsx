define([
    ...
    const EXTENSION_EXPORT = 'org.openlumify.graph.export';
    const EXTENSION_SELECT = 'org.openlumify.graph.selection';
    const EXTENSION_LAYOUT = 'org.openlumify.graph.layout';
