    ...
    function CollapsedNodePopoverShim() {
        this.popoverInitialize = function() {
            this.attacher = attacher()
                ...
                .path('org/openlumify/web/product/graph/dist/CollapsedNodePopoverConfig')
        ...
        this.getTemplate = function() {
            return new Promise(
                f => require(['org/openlumify/web/product/graph/popovers/collapsedNode/collapsedNodePopoverTpl.hbs'], f)
            );
        };
    }
});
