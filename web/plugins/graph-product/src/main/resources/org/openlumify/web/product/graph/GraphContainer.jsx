define([
    ...
    /**
     * @deprecated Use {@link org.openlumify.product.toolbar.item} instead
     */
    registry.documentExtensionPoint('org.openlumify.graph.options',
        'Add components to the graph product toolbar',
        function(e) {
            return ('identifier' in e) && ('optionComponentPath' in e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphOptions'
    );
     ...
     * Decorations, etc.
     *
     * The default stylesheet is defined in [styles.js](https://github.com/openlumify/openlumify/blob/master/web/plugins/graph-product/src/main/resources/org/openlumify/web/product/graph/styles.js#L46)
     *
     * @param {org.openlumify.graph.style~StyleFn} config Cytoscape style function
     * @example
     * registry.registerExtension('org.openlumify.graph.style', function(cytoscapeStylesheet) {
     ...
     * });
     */
    registry.documentExtensionPoint('org.openlumify.graph.style',
        'Apply additional cytoscape styles',
        function(e) {
            return _.isFunction(e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphStyle'
    );
     ...
     * That allows them to be styled just like vertices using {@link org.openlumify.graph.style} extensions.
     *
     ...
     * @param {object|org.openlumify.graph.node.decoration~data} data The cytoscape data object for the decoration node
     * @param {string|org.openlumify.graph.node.decoration~classes} [classes]
     * Classes to add to the cytoscape node, useful for styling with {@link org.openlumify.graph.style}
     *
     * Include multiple `classes` using space-separated string
     * @param {org.openlumify.graph.node.decoration~applyTo} [applyTo] Whether the
     ...
     * @param {org.openlumify.graph.node.decoration~onClick} [onClick] This function is called on click events
     * @param {org.openlumify.graph.node.decoration~onMouseOver} [onMouseOver] This function is called on mouseover events
     * @param {org.openlumify.graph.node.decoration~onMouseOut} [onMouseOut] This function is called on mouseout events
     * @example
     * registry.registerExtension('org.openlumify.graph.node.decoration', {
     ...
     * });
     */
    registry.documentExtensionPoint('org.openlumify.graph.node.decoration',
        ...
        'http://docs.openlumify.org/extension-points/front-end/graphDecorations'
    );
     ...
     * @param {string} componentPath The path to {@link org.openlumify.graph.export~Exporter|exporter component}
     ...
     */
    registry.documentExtensionPoint('org.openlumify.graph.export',
        'Add menu options to export graph / workspace',
        function(e) {
            return ('menuItem' in e) && ('componentPath' in e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphExport'
    );
     ...
     * registry.registerExtension('org.openlumify.graph.selection', doRandomSelection);
     */
    registry.documentExtensionPoint('org.openlumify.graph.selection',
        ...
        'http://docs.openlumify.org/extension-points/front-end/graphSelector'
    );
     ...
     *     return this;
     * };
     * registry.registerExtension('org.openlumify.graph.layout', MyLayout);
     */
    registry.documentExtensionPoint('org.openlumify.graph.layout',
        'Add new cytoscape layouts to graph menu',
        function(e) {
            return ('identifier' in e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphLayout'
    );
     ...
     * component
     */
    registry.documentExtensionPoint('org.openlumify.graph.view',
        'Add components to graph container',
        function(e) {
            return ('componentPath' in e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphView'
    );

    /**
     * Register a function that can add or remove classes from cytoscape collapsed nodes for custom styling.
     *
     * @param {org.openlumify.graph.collapsed.class~classFn} config
     */
    registry.documentExtensionPoint('org.openlumify.graph.collapsed.class',
        'Function that can change cytoscape classes of nodes',
        function(e) {
            return _.isFunction(e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphCollapsedNode/class.html'
    );

    /**
     * Register a function that can add or remove classes from cytoscape nodes for custom styling.
     *
     * @param {org.openlumify.graph.node.class~classFn} config
     */
    registry.documentExtensionPoint('org.openlumify.graph.node.class',
        'Function that can change cytoscape classes of nodes',
        function(e) {
            return _.isFunction(e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphNode/class.html'
    );

    /**
     * Register a function that can add or remove classes from cytoscape edges for custom styling.
     *
     * @param {org.openlumify.graph.edge.class~classFn} config
     */
    registry.documentExtensionPoint('org.openlumify.graph.edge.class',
        'Function that can change cytoscape classes of edges',
        function(e) {
            return _.isFunction(e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphEdge/class.html'
    );

    /**
     * Allows extensions to adjust the `data` attribute of cytoscape nodes.
     * @param {org.openlumify.graph.node.transformer~transformerFn} config
     */
    registry.documentExtensionPoint('org.openlumify.graph.node.transformer',
        'Function that can change cytoscape node structure',
        function(e) {
            return _.isFunction(e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphNode/transformer.html'
    );

    registry.markUndocumentedExtensionPoint('org.openlumify.graph.ancillary');

    /**
     * Allows extensions to adjust the `data` attribute of cytoscape edges.
     * @param {org.openlumify.graph.edge.transformer~transformerFn} config
     */
    registry.documentExtensionPoint('org.openlumify.graph.edge.transformer',
        'Function that can change cytoscape edge structure',
        function(e) {
            return _.isFunction(e);
        },
        'http://docs.openlumify.org/extension-points/front-end/graphEdge/transformer.html'
    );
    registry.registerExtension('org.openlumify.product.toolbar.item', {
        identifier: 'toggleEdgeLabel',
        itemComponentPath: 'org/openlumify/web/product/graph/dist/EdgeLabel',
        canHandle: (product) => product.kind === 'org.openlumify.web.product.graph.GraphWorkProduct'
    });
    registry.registerExtension('org.openlumify.product.toolbar.item', {
        identifier: 'toggleSnapToGrid',
        itemComponentPath: 'org/openlumify/web/product/graph/dist/SnapToGrid',
        canHandle: (product) => product.kind === 'org.openlumify.web.product.graph.GraphWorkProduct'
    });
    registry.registerExtension('org.openlumify.vertex.menu', {
        ...
        shouldDisable: function(selection, vertexId, target) {
            ...
            var graph = document.querySelector('.org-openlumify-graph');
            if (graph) {
    ...
    registry.registerExtension('org.openlumify.vertex.menu', {
        ...
        shouldDisable: function(selection, vertexId, target) {
            return $(target).closest('.org-openlumify-graph').length === 0;
        },
        options: {
            insertIntoMenuItems: function(item, items) {
    ...
    const GraphContainer = redux.connect(
        ...
        (state, props) => {
            var pixelRatio = state.screen.pixelRatio,
                ...
                ghosts = state['org-openlumify-graph'].animatingGhosts,
        ...
        null,
        { withRef: true }
    )(DroppableHOC(Graph, '.org-openlumify-graph'));
