...
define([
    ...
    function CreateConnectionPopover() {
        ...
        this.updateRelationshipLabels = function() {
            ...
            button.text(i18n('org.openlumify.web.product.graph.connection.button.connect')).prop('disabled', true);
        ...
        this.onCreateConnection = function(e) {
            ...
            this.dataRequest('edge', 'create', parameters)
                ...
                .catch(function(error) {
                    $target.text(i18n('org.openlumify.web.product.graph.connection.button.connect'))
                        .prop('disabled', false);
