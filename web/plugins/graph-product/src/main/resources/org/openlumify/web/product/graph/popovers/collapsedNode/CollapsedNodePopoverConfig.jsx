define([
    ...
    const CollapsedNodePopoverConfig = createReactClass({
        ...
        componentDidMount() {
            $(document).on('keydown.org-openlumify-graph-collapsed-node-popover', (event) => {
                switch (event.which) {
        ...
        componentWillUnmount() {
            $(document).off('.org-openlumify-graph-collapsed-node-popover');
        },
            ...
            return (
                <div className="title-edit">
                    <input
                        ...
                        type="text"
                        placeholder={i18n('org.openlumify.web.product.graph.collapsedNode.popover.automatic.title')}
                    ...
                    <button
                        ...
                        {i18n('org.openlumify.web.product.graph.collapsedNode.popover.rename')}
                    </button>
                </div>
            );
        },
