        ...
        render() {
            ...
            return (<div className="find-path-edges-config">
                <div className="header">
                    <div className="title">{i18n('org.openlumify.web.product.graph.findPath.edges.title')}</div>
                    <div className="actions">
                        <button
                            onClick={this.handleCancel}
                            className="btn btn-link">{i18n('org.openlumify.web.product.graph.findPath.edges.cancel')}</button>
                    </div>
                </div>
                    ...
                    <div className="edge-list-header">
                        <div className="buttons">
                            <button
                                ...
                                className="btn btn-mini">{i18n('org.openlumify.web.product.graph.findPath.edges.select.all')}</button>
                            <button
                                onClick={this.handleSelectNoneClicked}
                                className="btn btn-mini">{i18n('org.openlumify.web.product.graph.findPath.edges.select.none')}</button>
                            <button onClick={this.handleSelectResetClicked}
                                    className="btn btn-mini">{i18n('org.openlumify.web.product.graph.findPath.edges.select.reset')}</button>
                        </div>
                ...
                <div className="actions">
                    <button onClick={this.handleLimitClick}
                            ...
                            className="btn">{
                                ...
                                i18n('org.openlumify.web.product.graph.findPath.edges.ok.single') :
                                i18n('org.openlumify.web.product.graph.findPath.edges.ok', this.state.selectedEdgeIris.length)
                            }</button>
                </div>
            </div>);
        }
