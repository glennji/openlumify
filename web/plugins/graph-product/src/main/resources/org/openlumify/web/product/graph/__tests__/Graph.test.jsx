...
it('Should only call extension functions on vertex changes', () => {
    ...
    const changeRegistry = updeep({
        'org.openlumify.graph.edge.class': add(count('edgeClass-3', '')),
        'org.openlumify.graph.edge.transformer': add(count('edgeTransform-3', {})),
        'org.openlumify.graph.node.class': add(count('class-3', '')),
        'org.openlumify.graph.node.transformer': add(count('transform-3', {})),
        'org.openlumify.graph.node.decoration': add({ applyTo: count('applyTo-3', true), data: count('data-3', {}) })
    }, props.registry)
