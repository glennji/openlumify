define([
    ...
    const AUTH_EXTENSION_POINT = 'org.openlumify.ingest.cloud.s3.auth';

    /**
     * Add other UI to authenticate to an s3 instance.
     */
    RegistryInjectorHOC.registry.documentExtensionPoint('org.openlumify.ingest.cloud.s3.auth',
    ...
    RegistryInjectorHOC.registry.registerExtension(AUTH_EXTENSION_POINT, {
        ...
        componentPath: 'org/openlumify/web/ingest/cloud/s3/dist/BasicAuth',
        providerClass: 'org.openlumify.web.ingest.cloud.s3.authentication.BasicAuthProvider'
    });
    RegistryInjectorHOC.registry.registerExtension(AUTH_EXTENSION_POINT, {
        id: 'session_auth',
        displayName: i18n('session_auth'),
        componentPath: 'org/openlumify/web/ingest/cloud/s3/dist/SessionAuth',
        providerClass: 'org.openlumify.web.ingest.cloud.s3.authentication.SessionAuthProvider'
    });
