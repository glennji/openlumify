...
public class RequestToken implements ParameterizedHandler {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(RequestToken.class);
    ...
    private void sendEmail(String to, String body) {
        try {
            ...
            throw new OpenLumifyException("exception while sending e-mail", e);
        }
    }
    ...
    private Session getSession() {
        ...
        switch (forgotPasswordConfiguration.getMailServerAuthentication()) {
            ...
            case SSL:
                ...
                break;
            default:
                throw new OpenLumifyException("unexpected MailServerAuthentication: " + forgotPasswordConfiguration.getMailServerAuthentication().toString());
        }
