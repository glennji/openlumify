define([
    ...
    const VECTOR_FEATURE_SELECTION_OVERLAY = 'org-openlumify-map-vector-selected-overlay';
                ...
                return withDataRequest.dataRequest('vertex', 'propertyValue', id, propName, propKey).then(source => {
                    ...
                    .catch(e => {
                        const message = e.message === 'unhandledDataProjection'
                            ? i18n('org.openlumify.web.product.map.MapWorkProduct.layer.error.data.format')
                            : i18n('org.openlumify.web.product.map.MapWorkProduct.layer.error');
