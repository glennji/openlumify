define([
    ...
    registry.registerExtension('org.openlumify.product.toolbar.item', {
        identifier: 'org-openlumify-map-layers',
        itemComponentPath: 'org/openlumify/web/product/map/dist/MapLayersContainer',
        placementHint: 'popover',
        label: i18n('org.openlumify.web.product.map.MapWorkProduct.layers.toolbar.item.label'),
        canHandle: (product) => product.kind === 'org.openlumify.web.product.map.MapWorkProduct'
    });
    ...
    return redux.connect(
        ...
        (state, props) => {
            ...
            const layerConfig = product.extendedData
                && product.extendedData['org-openlumify-map-layers']
                && product.extendedData['org-openlumify-map-layers'].config;
