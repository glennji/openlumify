define([
    ...
    function GeoShapePreview() {
        ...
        this.before('initialize', function(node, config) {
            ...
            this.unsubscribePadding = openlumifyData.storePromise.then(store => {
        ...
        this.setupMap = function() {
            ...
            const { source: olSource, layer: geoShapeLayer } = layerHelper.configure(this.element.id, {
                ...
                propName: 'http://openlumify.org#raw',
                propKey: '',
                mimeType: F.vertex.prop(this.element, 'http://openlumify.org#mimeType'),
                sourceOptions: {
                    wrapX: false
                }
            });
