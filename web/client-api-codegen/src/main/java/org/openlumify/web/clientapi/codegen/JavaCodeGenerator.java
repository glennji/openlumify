...
public class JavaCodeGenerator extends BasicJavaGenerator {
    public static final String BASE_CODEGEN_PACKAGE = "org.openlumify.web.clientapi.codegen";
    public static final String BASE_PACKAGE = "org.openlumify.web.clientapi";

    // Run with VMWarguments: "-DfileMap=src/main/resources/openlumify.json"
    //          Arguments:    "openlumify.json"
    //          Working Dir:  "$MODULE_DIR$"
    public static void main(String[] args) {
        try {
            ClientOpts opts = new ClientOpts();
            opts.setUri("https://openlumify-dev:8889");
    ...
    private void fixFiles() throws IOException {
        File destDir = new File(destinationDir(), "org/openlumify/web/clientapi/codegen");
        fixFiles(destDir);
    }
    ...
    private void fixFiles(File destDir) throws IOException {
        ...
        for (File f : files) {
            if (f.isDirectory()) {
                ...
                fileContents = fileContents.replaceAll("import org.openlumify.web.clientapi.model.Object;", "");
                fileContents = fileContents.replaceAll("import org.openlumify.web.clientapi.model.TResult;", "");
                fileContents = fileContents.replaceAll("import org.openlumify.web.clientapi.model.RawString;", "");
                fileContents = fileContents.replaceAll("import org.openlumify.web.clientapi.codegen.model.Object;", "");
                fileContents = fileContents.replaceAll("import org.openlumify.web.clientapi.codegen.model.LinkedHashMap;", "import java.util.Map;");
                fileContents = fileContents.replaceAll("import org.openlumify.web.clientapi.codegen.ApiInvoker;", "import org.openlumify.web.clientapi.ApiInvoker;");
