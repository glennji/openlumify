...
public class ResourceGet implements ParameterizedHandler {
    ...
    public void handle(
        ...
        if (glyph == null || !glyph.isValid()) {
            throw new OpenLumifyResourceNotFoundException("Could not find resource with id: " + id);
        }
    ...
    interface Glyph {
        ...
        void write(String tint, HttpServletRequest request, OpenLumifyResponse response) throws IOException;
    }
    ...
    abstract class AbstractGlyph implements Glyph {
        ...
        void write(BufferedImage bufferedImage, String tint, OutputStream outputStream) {
            ...
            try {
                ...
                throw new OpenLumifyException("Unable to tint image", e);
            }
        }
    }
    ...
    class Image extends AbstractGlyph {
        ...
        public void write(String tint, HttpServletRequest request, OpenLumifyResponse response) throws IOException {
