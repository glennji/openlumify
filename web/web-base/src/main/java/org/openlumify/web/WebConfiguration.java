...
import org.openlumify.core.model.properties.types.MetadataOpenLumifyProperty;
...
public class WebConfiguration {
    ...
    public static final PropertyMetadata PROPERTY_METADATA_SOURCE_TIMEZONE = new PropertyMetadata(
            "http://openlumify.org#sourceTimezone",
    ...
    public static final PropertyMetadata PROPERTY_METADATA_MODIFIED_DATE = new PropertyMetadata(
            OpenLumifyProperties.MODIFIED_DATE,
    ...
    public static final PropertyMetadata PROPERTY_METADATA_MODIFIED_BY = new PropertyMetadata(
            OpenLumifyProperties.MODIFIED_BY,
    ...
    public static final PropertyMetadata PROPERTY_METADATA_CONFIDENCE = new PropertyMetadata(
            OpenLumifyProperties.CONFIDENCE_METADATA,
    ...
    public static class PropertyMetadata {
        ...
        public PropertyMetadata(OpenLumifyPropertyBase openlumifyProperty, String messageKey, String dataType) {
            this(openlumifyProperty.getPropertyName(), messageKey, dataType);
        }

        public PropertyMetadata(MetadataOpenLumifyProperty openlumifyProperty, String messageKey, String dataType) {
            this(openlumifyProperty.getMetadataKey(), messageKey, dataType);
        }
