...
import org.openlumify.web.ContentSecurityPolicy;
...
public class Index implements ParameterizedHandler {
    ...
    private static final String LOGO_PATH_BUNDLE_KEY = "openlumify.loading-logo.path";
    private static final String CONTEXT_PATH = "contextPath";
    private static final Map<String, String> MESSAGE_BUNDLE_PARAMS = ImmutableMap.of(
            "title", "openlumify.title",
            "description", "openlumify.description"
    );
