...
import org.openlumify.core.ingest.FileImportSupportingFileHandler;
import org.openlumify.core.ingest.graphProperty.GraphPropertyWorker;
import org.openlumify.core.ingest.graphProperty.PostMimeTypeWorker;
import org.openlumify.core.ingest.graphProperty.TermMentionFilter;
...
public class PluginList implements ParameterizedHandler {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(PluginList.class);
