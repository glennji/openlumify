...
public class OpenLumifyResponse {
    ...
    public OpenLumifyResponse(HttpServletRequest request, HttpServletResponse response) {
    ...
    public void respondWithClientApiObject(ClientApiObject obj) throws IOException {
        ...
        try {
            ...
            throw new OpenLumifyException("Could not write json", e);
        }
    }
    ...
    public OutputStream getOutputStream() {
        try {
            ...
            throw new OpenLumifyException("Could not get response output stream", e);
        }
    }
    ...
    public void flushBuffer() {
        try {
            ...
            throw new OpenLumifyException("Could not flush response buffer");
        }
    }
        ...
        try {
            switch (type) {
                ...
                case HTML:
                    ...
                    break;
                default:
                    throw new OpenLumifyException("Unsupported response type encountered");
            }
            ...
            throw new OpenLumifyException("Error occurred while writing response", e);
        }
    }
