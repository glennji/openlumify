...
public class AuthTokenHttpResponse extends HttpServletResponseWrapper {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(AuthTokenHttpResponse.class);
    private static final String EXPIRATION_HEADER_NAME = "OpenLumify-Auth-Token-Expiration";
