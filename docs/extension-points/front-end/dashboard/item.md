...
* [Dashboard Item JavaScript API `org.openlumify.dashboard.item`](../../../javascript/org.openlumify.dashboard.item.html)
* [Dashboard Item Example Code](https://github.com/openlumify/doc-examples/tree/master/extension-dashboard-item)
...
{% github_embed "https://github.com/openlumify/doc-examples/blob/7d006a2e/extension-dashboard-item/src/main/java/org/openlumify/examples/dashboard_item/DashboardItemWebAppPlugin.java#L17-L22" %}{% endgithub_embed %}

### Register Extension

Register two extensions, a report-style card, and a custom component.

{% github_embed "https://github.com/openlumify/doc-examples/blob/7d006a2e/extension-dashboard-item/src/main/resources/org/openlumify/examples/dashboard_item/plugin.js#L3-L31", hideLines=['8-21'] %}{% endgithub_embed %}

#### Report Configuration

The report configuration uses [OpenLumify element search](../../../javascript/org.openlumify.dashboard.item.html#~reportParametersForSearch)

{% github_embed "https://github.com/openlumify/doc-examples/blob/7d006a2e/extension-dashboard-item/src/main/resources/org/openlumify/examples/dashboard_item/plugin.js#L8-L21" %}{% endgithub_embed %}
...
{% github_embed "https://github.com/openlumify/doc-examples/blob/7d006a2e/extension-dashboard-item/src/main/resources/org/openlumify/examples/dashboard_item/React.jsx#L11-L14" %}{% endgithub_embed %}

In the configuration component, we increment the count (creating if needed) when the button is clicked.

{% github_embed "https://github.com/openlumify/doc-examples/blob/e013c675/extension-dashboard-item/src/main/resources/org/openlumify/examples/dashboard_item/Config.jsx#L15-L22" %}{% endgithub_embed %}
...
{% github_embed "https://github.com/openlumify/doc-examples/blob/1ea91e17/extension-dashboard-item/src/main/resources/org/openlumify/examples/dashboard_item/React.jsx#L23" %}{% endgithub_embed %}

Then, listen for the event, we must use Jquery to listen as Flight uses non-standard event triggering.

{% github_embed "https://github.com/openlumify/doc-examples/blob/1ea91e17/extension-dashboard-item/src/main/resources/org/openlumify/examples/dashboard_item/React.jsx#L7-L15" %}{% endgithub_embed %}

Finally, unregister the listener on teardown

{% github_embed "https://github.com/openlumify/doc-examples/blob/1ea91e17/extension-dashboard-item/src/main/resources/org/openlumify/examples/dashboard_item/React.jsx#L16-L18" %}{% endgithub_embed %}
