...
{% github_embed "https://github.com/openlumify/openlumify/blob/3709844f/web/war/src/main/webapp/js/detail/item/layoutComponents/generic.js#L64-L72" %}{% endgithub_embed %}
