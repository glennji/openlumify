...
import org.apache.tika.parser.pdf.OpenLumifyParserConfig;
...
import org.openlumify.core.model.properties.types.LongOpenLumifyProperty;
...
/**
 * By default raw properties will be text extracted into "http://openlumify.org#text" with a text description of "Extracted Text".
 * <p>
 * Configuration:
 * <p>
 * <pre><code>
 * org.openlumify.tikaTextExtractor.TikaTextExtractorGraphPropertyWorker.textExtractMapping.prop1.rawPropertyName=http://my.org#prop1
 * org.openlumify.tikaTextExtractor.TikaTextExtractorGraphPropertyWorker.textExtractMapping.prop1.extractedTextPropertyName=http://my.org#prop1
 * org.openlumify.tikaTextExtractor.TikaTextExtractorGraphPropertyWorker.textExtractMapping.prop1.textDescription=My Property 1
 *
 * org.openlumify.tikaTextExtractor.TikaTextExtractorGraphPropertyWorker.textExtractMapping.prop2.rawPropertyName=http://my.org#prop2
 * org.openlumify.tikaTextExtractor.TikaTextExtractorGraphPropertyWorker.textExtractMapping.prop2.extractedTextPropertyName=http://my.org#prop2
 * org.openlumify.tikaTextExtractor.TikaTextExtractorGraphPropertyWorker.textExtractMapping.prop2.textDescription=My Property 2
 * </code></pre>
 */
...
public class TikaTextExtractorGraphPropertyWorker extends GraphPropertyWorker {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(TikaTextExtractorGraphPropertyWorker.class);
    ...
    private LongOpenLumifyProperty pageCountProperty;
    ...
    public void prepare(GraphPropertyWorkerPrepareData workerPrepareData) throws Exception {
        ...
        if (pageCountPropertyIri != null) {
            pageCountProperty = new LongOpenLumifyProperty(pageCountPropertyIri);
        }
    ...
    public void execute(InputStream in, GraphPropertyWorkData data) throws Exception {
        String mimeType = (String) data.getProperty().getMetadata().getValue(OpenLumifyProperties.MIME_TYPE.getPropertyName());
        checkNotNull(mimeType, OpenLumifyProperties.MIME_TYPE.getPropertyName() + " is a required metadata field");
        ...
        OpenLumifyProperties.MIME_TYPE_METADATA.setMetadata(textMetadata, "text/plain", defaultVisibility);
        if (!Strings.isNullOrEmpty(textExtractMapping.getTextDescription())) {
            OpenLumifyProperties.TEXT_DESCRIPTION_METADATA.setMetadata(
                    textMetadata,
        ...
        if (customImageMetadata != null && !customImageMetadata.equals("")) {
            try {
                ...
                OpenLumifyProperties.MODIFIED_DATE.setProperty(m, lastUpdate, defaultVisibility);
                ...
                if (titlePropertyIri != null) {
                    ...
                    OpenLumifyProperties.CONFIDENCE_METADATA.setMetadata(titleMetadata, SYSTEM_ASSIGNED_CONFIDENCE, defaultVisibility);
            ...
            OpenLumifyProperties.MODIFIED_DATE.setProperty(m, extractDate(metadata), defaultVisibility);
            ...
            if (pageCountProperty != null) {
                ...
                if (!Strings.isNullOrEmpty(numberOfPages)) {
                    ...
                    OpenLumifyProperties.CONFIDENCE_METADATA.setMetadata(numberOfPagesMetadata, SYSTEM_ASSIGNED_CONFIDENCE, defaultVisibility);
    ...
    private String getPropertyKey(GraphPropertyWorkData data) {
        ...
        if (OpenLumifyProperties.TEXT.getProperty(data.getElement(), MULTI_VALUE_KEY) != null) {
    ...
    private static String extractTextWithTika(InputStream stream, Metadata metadata) throws TikaException, SAXException, IOException {
        ...
        context.set(PDFParserConfig.class, new OpenLumifyParserConfig());
    ...
    public boolean isHandled(Element element, Property property) {
        ...
        String mimeType = OpenLumifyProperties.MIME_TYPE_METADATA.getMetadataValue(property.getMetadata());
        if (mimeType == null) {
            return false;
        }
