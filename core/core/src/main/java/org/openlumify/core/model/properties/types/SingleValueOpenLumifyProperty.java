...
import org.openlumify.web.clientapi.model.ClientApiProperty;
...
public abstract class SingleValueOpenLumifyProperty<TRaw, TGraph> extends OpenLumifyPropertyBase<TRaw, TGraph> {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(SingleValueOpenLumifyProperty.class);

    protected SingleValueOpenLumifyProperty(String propertyName) {
        super(propertyName);
    }
    ...
    public void removeProperty(
        ...
        if (currentValue != null) {
            ...
            changedPropertiesOut.add(new OpenLumifyPropertyUpdateRemove(this, beforeDeletionTimestamp, true, false));
        }
    }
    ...
    public void updateProperty(
        ...
        if (currentValue == null || !isEquals(newValue, currentValue)) {
            ...
            changedPropertiesOut.add(new OpenLumifyPropertyUpdate(this));
        }
    }
