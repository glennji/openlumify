...
public class Duration {
    ...
    public double getTimeInMillis() {
        ...
        throw new OpenLumifyException("Unhandled time unit: " + timeUnit);
    }
    ...
    public static Duration parse(String str) {
        ...
        if (!m.matches()) {
            throw new OpenLumifyException("Could not parse duration string: " + str);
        }
        try {
            ...
            throw new OpenLumifyException("Could not parse duration string: " + str, ex);
        }
    }
