...
public abstract class UserPropertyAuthorizationRepositoryBase extends AuthorizationRepositoryBase {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(UserPropertyAuthorizationRepositoryBase.class);
    public static final String AUTHORIZATIONS_PROPERTY_IRI = "http://openlumify.org/user#authorizations";
    ...
    public Set<String> getAuthorizations(User user) {
        if (user instanceof SystemUser) {
            return Sets.newHashSet(OpenLumifyVisibility.SUPER_USER_VISIBILITY_STRING);
        }
