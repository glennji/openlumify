 ...
 */
public class LocalDateSingleValueOpenLumifyProperty
        extends SingleValueOpenLumifyProperty<LocalDate, Date>
        implements WrapsLocalDate {

    public LocalDateSingleValueOpenLumifyProperty(String propertyName) {
        super(propertyName);
    }
