...
public class LoggingThread extends Thread {
    ...
    private OpenLumifyLogger logger;

    public LoggingThread(InputStream inputStream, OpenLumifyLogger logger, String prefix) {
    ...
    public LoggingThread(InputStream inputStream, OutputStream redirect,
                         OpenLumifyLogger logger, StringBuffer contentBuffer, String prefix) {
