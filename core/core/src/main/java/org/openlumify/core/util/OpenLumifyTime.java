...
public class OpenLumifyTime {
    private final String hours;
    private final String minutes;
    private final String seconds;
    private final String milliseconds;

    public OpenLumifyTime(Integer hours, Integer minutes, Integer seconds, Integer milliseconds) {
        this(
    ...
    public OpenLumifyTime(String hours, String minutes, String seconds, String milliseconds) {
    ...
    public boolean equals(Object o) {
        ...
        OpenLumifyTime that = (OpenLumifyTime) o;
