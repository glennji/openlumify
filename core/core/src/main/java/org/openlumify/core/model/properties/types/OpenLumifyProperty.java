...
public abstract class OpenLumifyProperty<TRaw, TGraph> extends OpenLumifyPropertyBase<TRaw, TGraph> {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(OpenLumifyProperty.class);

    protected OpenLumifyProperty(String propertyName) {
        super(propertyName);
    }
    ...
    public void removeProperty(
            List<OpenLumifyPropertyUpdate> changedPropertiesOut,
            Element element,
            ElementMutation m,
            String propertyKey,
            Visibility visibility
        ...
        if (currentValue != null) {
            ...
            changedPropertiesOut.add(new OpenLumifyPropertyUpdateRemove(this, propertyKey, beforeDeletionTimestamp, true, false));
        }
    }
    ...
    public void hideProperty(
        ...
        changedPropertiesOut.add(new OpenLumifyPropertyUpdateRemove(this, propertyToHide.getKey(), beforeDeletionTimestamp, false, true));
    }
    ...
    public void updateProperty(
        ...
        if (currentValue == null || !isEquals(newValue, currentValue)) {
            ...
            changedPropertiesOut.add(new OpenLumifyPropertyUpdate(this, propertyKey));
        }
    }
