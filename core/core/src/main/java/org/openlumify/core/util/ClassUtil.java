...
public class ClassUtil {
    ...
    public static <T> Class<? extends T> forName(String className) {
        try {
            ...
            throw new OpenLumifyException("Could not load class " + className, e);
        }
    }
    ...
    public static void logClasspath(ClassLoader classLoader, OpenLumifyLogger openlumifyLogger) {
        outputClasspath(classLoader, openlumifyLogger);
    }
    ...
    private static void outputClasspath(ClassLoader classLoader, Object outputObject) {
        ...
        } else if (outputObject instanceof OpenLumifyLogger) {
            ((OpenLumifyLogger) outputObject).debug(sb.toString());
        } else {
            throw new OpenLumifyException("unexpected outputObject");
        }
