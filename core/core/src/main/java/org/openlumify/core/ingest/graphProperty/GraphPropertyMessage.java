...
public class GraphPropertyMessage {
    ...
    public static GraphPropertyMessage create(byte[] data) {
        try {
            ...
            throw new OpenLumifyException("Could not create " + GraphPropertyMessage.class.getName() + " from " + new String(data), e);
        }
    }
    ...
    public String toJsonString() {
        try {
            ...
            throw new OpenLumifyException("Could not write " + this.getClass().getName(), e);
        }
    }
