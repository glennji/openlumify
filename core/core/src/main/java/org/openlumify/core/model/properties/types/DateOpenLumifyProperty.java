...
/**
 * A OpenLumifyProperty that converts Dates to an appropriate value for
 * storage in Vertexium.
 */
public class DateOpenLumifyProperty extends IdentityOpenLumifyProperty<Date> {
    public DateOpenLumifyProperty(String key) {
        super(key);
    }
