...
public class JSONUtil {
    ...
    public static Object parseObject(Object value) {
        if (value == null) {
            ...
            throw new OpenLumifyException("Could not parse object: " + value);
        }
    }
    ...
    public static JSONObject parse(String jsonString) {
        try {
            ...
            throw new OpenLumifyJsonParseException(jsonString, ex);
        }
    }
    ...
    public static JSONArray parseArray(String s) {
        try {
            ...
            throw new OpenLumifyJsonParseException(s, ex);
        }
    }
    ...
    public static JsonNode toJsonNode(JSONObject json) {
        try {
            ...
            throw new OpenLumifyException("Could not create json node from: " + json.toString(), e);
        }
    }
