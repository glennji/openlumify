...
/**
 * A OpenLumifyProperty provides convenience methods for converting standard
 ...
 */
public abstract class OpenLumifyPropertyBase<TRaw, TGraph> {
    private final String propertyName;
    private final Function<Object, TRaw> rawConverter;

    protected OpenLumifyPropertyBase(final String propertyName) {
