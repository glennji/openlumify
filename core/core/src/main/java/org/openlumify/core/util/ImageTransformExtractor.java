...
public class ImageTransformExtractor {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(ImageTransformExtractor.class);
    ...
    /**
     * Converts an orientation number to an ImageTransform object used by OpenLumify.
     *
