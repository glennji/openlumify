...
public class MetadataGraphPropertyWorker extends GraphPropertyWorker {
    ...
    private void setProperty(JSONObject propertyJson, GraphPropertyWorkData data) {
        ...
        OpenLumifyProperties.VISIBILITY_JSON_METADATA.setMetadata(metadata, VisibilityJson.updateVisibilitySource(null, visibilitySource), getVisibilityTranslator().getDefaultVisibility());
    ...
    public JSONObject getMetadataJson(GraphPropertyWorkData data) throws IOException {
        StreamingPropertyValue metadataJsonValue = OpenLumifyProperties.METADATA_JSON.getPropertyValue(data.getElement());
    ...
    public boolean isHandled(Element element, Property property) {
        ...
        StreamingPropertyValue mappingJson = OpenLumifyProperties.METADATA_JSON.getPropertyValue(element);
        if (mappingJson == null) {
            return false;
        }
