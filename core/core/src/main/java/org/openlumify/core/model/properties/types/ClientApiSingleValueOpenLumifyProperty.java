...
public abstract class ClientApiSingleValueOpenLumifyProperty<TClientApi> extends SingleValueOpenLumifyProperty<TClientApi, String> {
    private final Class<TClientApi> clazz;

    public ClientApiSingleValueOpenLumifyProperty(String key, Class<TClientApi> clazz) {
        super(key);
        this.clazz = clazz;
    }
