...
public class OpenLumifyDateTime implements Comparable<OpenLumifyDateTime> {
    public static final String DATE_TIME_NO_TIME_ZONE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss";
    private static final TimeZone GMT = TimeZone.getTimeZone("GMT");
    private final OpenLumifyTime time;
    private final OpenLumifyDate date;
    private final String timeZone;

    public OpenLumifyDateTime(Integer year, Integer month, Integer date, Integer hour, Integer minutes, Integer seconds, Integer milliseconds, String timeZone) {
        this(
                new OpenLumifyDate(year, month, date),
                new OpenLumifyTime(hour, minutes, seconds, milliseconds),
                timeZone
        );
    }

    public OpenLumifyDateTime(String year, String month, String date, String hour, String minutes, String seconds, String milliseconds, String timeZone) {
        this(new OpenLumifyDate(year, month, date), new OpenLumifyTime(hour, minutes, seconds, milliseconds), timeZone);
    }

    public OpenLumifyDateTime(OpenLumifyDate date, OpenLumifyTime time, String timeZone) {
        this.date = date;
        this.time = time;
    ...
    public static OpenLumifyDateTime create(Object obj) {
        return create(obj, TimeZone.getDefault());
    }

    public static OpenLumifyDateTime create(Object obj, TimeZone defaultTimeZone) {
        if (obj == null) {
            return null;
        }
        ...
        throw new OpenLumifyException("Invalid object type to convert to " + OpenLumifyDateTime.class.getSimpleName() + ": " + obj.getClass().getName());
    }

    public static OpenLumifyDateTime create(Date date, String timeZoneString) {
        TimeZone timeZone = TimeZone.getTimeZone(timeZoneString);
        return create(date, timeZone);
    }

    public static OpenLumifyDateTime create(Date date, TimeZone timeZone) {
        Calendar cal = Calendar.getInstance(timeZone);
        cal.setTime(date);
        return new OpenLumifyDateTime(
    ...
    public static OpenLumifyDateTime parse(String str, TimeZone defaultTimeZone) {
    ...
    public boolean equals(Object o) {
        ...
        OpenLumifyDateTime that = (OpenLumifyDateTime) o;
    ...
    public OpenLumifyTime getTime() {
        return time;
    }

    public OpenLumifyDate getDate() {
        return date;
    }
    ...
    public OpenLumifyDateTime add(int amount, OpenLumifyDate.Unit units) {
        switch (units) {
            case DAY:
                Calendar cal = Calendar.getInstance();
                cal.setTime(getJavaDate());
                cal.add(Calendar.DATE, amount);
                return OpenLumifyDateTime.create(cal.getTime(), getTimeZone());
            default:
                throw new OpenLumifyException("Unhandled unit: " + units);
        }
    }

    @Override
    public int compareTo(OpenLumifyDateTime o) {
