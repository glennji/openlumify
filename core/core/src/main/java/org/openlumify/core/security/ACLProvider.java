...
import static org.openlumify.core.model.properties.OpenLumifyProperties.CONCEPT_TYPE_THING;
import static org.openlumify.core.model.user.PrivilegeRepository.hasPrivilege;

public abstract class ACLProvider {
    private static final OpenLumifyLogger LOGGER = OpenLumifyLoggerFactory.getLogger(ACLProvider.class);
    ...
    private void checkCanAddOrUpdateProperty(
            ...
            User user,
            String workspaceId
    ) throws OpenLumifyAccessDeniedException {
    ...
    private void checkCanDeleteProperty(
        ...
        if (!canDelete) {
            throw new OpenLumifyAccessDeniedException(propertyName + " cannot be deleted due to ACL restriction", user, element.getId());
        }
    }
    ...
    private ClientApiElementAcl elementACL(
        ...
        if (clientApiElement instanceof ClientApiVertex) {
            String iri = OpenLumifyProperties.CONCEPT_TYPE.getPropertyValue(clientApiElement);
            while (iri != null) {
            ...
            throw new OpenLumifyException("unsupported ClientApiElement class " + clientApiElement.getClass().getName());
        }
        return elementAcl;
    }
    ...
    protected final boolean isAuthor(Element element, String propertyKey, String propertyName, User user, String workspaceId) {
        ...
        if (property != null) {
            String authorUserId = OpenLumifyProperties.MODIFIED_BY_METADATA.getMetadataValue(property.getMetadata());
    ...
    protected OntologyElement getOntologyElement(Element element, String workspaceId) {
        ...
        throw new OpenLumifyException("Unexpected " + Element.class.getName() + " found " + element.getClass().getName());
    }
    ...
    protected OntologyElement getOntologyElement(ClientApiElement clientApiElement, Ontology ontology, String workspaceId) {
        ...
        throw new OpenLumifyException("Unexpected " + ClientApiVertex.class.getName() + " found " + clientApiElement.getClass().getName());
    }
    ...
    private Concept getOntologyConceptFromElement(Vertex vertex, Ontology ontology, String workspaceId) {
        String iri = OpenLumifyProperties.CONCEPT_TYPE.getPropertyValue(vertex, CONCEPT_TYPE_THING);
