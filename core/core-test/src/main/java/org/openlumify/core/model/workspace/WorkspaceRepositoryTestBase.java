...
public abstract class WorkspaceRepositoryTestBase extends OpenLumifyInMemoryTestBase {
    ...
    public void before() throws Exception {
        super.before();
        user = getUserRepository().findOrAddUser("base-junit", "Base Junit", "base-junit@openlumify.com", "password");
