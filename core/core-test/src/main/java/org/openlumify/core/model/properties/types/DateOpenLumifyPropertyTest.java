...
public class DateOpenLumifyPropertyTest extends OpenLumifyInMemoryTestBase {
    private User user;
    private Authorizations authorizations;
    private PropertyMetadata metadata;
    private DateOpenLumifyProperty prop;
    ...
    public void before() throws Exception {
        ...
        prop = new DateOpenLumifyProperty("name");
    }
    ...
    private void testUpdateProperty(DateOpenLumifyProperty prop, Date expectedValue, Date oldValue, GraphUpdateContext.Update<Element> update) {
