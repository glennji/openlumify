...
import static org.openlumify.core.model.properties.OpenLumifyProperties.COMMENT;
...
public class ACLProviderTest {
    ...
    public void before() {
        ...
        when(vertex.getPropertyValue(OpenLumifyProperties.CONCEPT_TYPE.getPropertyName())).thenReturn("vertex");
        ...
        when(elementConceptTypeProperty.getName()).thenReturn(OpenLumifyProperties.CONCEPT_TYPE.getPropertyName());
