...
public class TermMentionRepositoryTest extends OpenLumifyInMemoryTestBase {
    ...
    public void testDelete() {
        ...
        OpenLumifyProperties.TERM_MENTION_RESOLVED_EDGE_ID.setProperty(v1tm1, "v1_to_v2", termMentionVisibility, authorizations);
        Vertex v2 = getGraph().addVertex("v2", visibility, authorizations);
        getGraph().addEdge("v1_to_c1tm1", v1, v1tm1, OpenLumifyProperties.TERM_MENTION_LABEL_HAS_TERM_MENTION, termMentionVisibility, authorizations);
        getGraph().addEdge("c1tm1_to_v2", v1tm1, v2, OpenLumifyProperties.TERM_MENTION_LABEL_RESOLVED_TO, termMentionVisibility, authorizations);
    ...
    public void testFindResolvedToForRef() {
        ...
        OpenLumifyProperties.TERM_MENTION_REF_PROPERTY_KEY.setProperty(tmBuilder, "key", termMentionVisibility);
        OpenLumifyProperties.TERM_MENTION_REF_PROPERTY_NAME.setProperty(tmBuilder, "name", termMentionVisibility);
        Vertex tm = tmBuilder.save(authorizations);
        getGraph().addEdge("tm_to_v", tm, v, OpenLumifyProperties.TERM_MENTION_LABEL_RESOLVED_TO, termMentionVisibility, authorizations);
        getGraph().flush();
