...
public class VertexSearchRunnerTest extends SearchRunnerTestBase {
    ...
    public void testSearchRelated() throws Exception {
        ...
        OpenLumifyProperties.CONCEPT_TYPE.setProperty(v1Mutation, "testConcept", new Visibility(""));
        OpenLumifyProperties.CONCEPT_TYPE.setProperty(v2Mutation, "testConcept", new Visibility(""));
        OpenLumifyProperties.CONCEPT_TYPE.setProperty(v3Mutation, "testConcept", new Visibility(""));
