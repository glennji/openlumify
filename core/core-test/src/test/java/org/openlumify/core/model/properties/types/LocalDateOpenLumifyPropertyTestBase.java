...
public abstract class LocalDateOpenLumifyPropertyTestBase {
    ...
    public void wrapReturnsLegacyDateAtMidnightUTCForLocalDate() throws Exception {
        ...
        Date legacyDateTime = createOpenLumifyProperty().wrap(localDate);
    ...
    public void unwrapReturnsLocalDateForLegacyDate() throws Exception {
        ...
        LocalDate localDate = createOpenLumifyProperty().unwrap(legacyDateTime);
    ...
    protected abstract WrapsLocalDate createOpenLumifyProperty();
}
