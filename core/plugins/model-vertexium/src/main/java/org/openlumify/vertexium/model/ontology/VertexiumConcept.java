...
public class VertexiumConcept extends Concept {
    ...
    public byte[] getGlyphIcon() {
        try {
            ...
            throw new OpenLumifyResourceNotFoundException("Could not retrieve glyph icon");
        }
    }
    ...
    public byte[] getGlyphIconSelected() {
        try {
            ...
            throw new OpenLumifyResourceNotFoundException("Could not retrieve glyph icon selected");
        }
    }
    ...
    public byte[] getMapGlyphIcon() {
        try {
            ...
            throw new OpenLumifyResourceNotFoundException("Could not retrieve map glyph icon");
        }
    }
