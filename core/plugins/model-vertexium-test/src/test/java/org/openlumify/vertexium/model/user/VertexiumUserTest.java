...
public class VertexiumUserTest {
    ...
    public void testGetCustomPropertiesFilterBuiltInProperties() {
        ...
        when(builtInProp.getName()).thenReturn(UserOpenLumifyProperties.PASSWORD_HASH.getPropertyName());
        ...
        assertFalse(customProperties.containsKey(UserOpenLumifyProperties.PASSWORD_HASH.getPropertyName()));
